...
@view
func game{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(game_id: felt) -> (game: Game):
...
@external
func play{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(game_id: felt, hashed_move: felt):
    let (player1) = player1_storage.read(game_id)
    let (player2) = player2_storage.read(game_id)
    let (hashed_move1) = hashed_move1_storage.read(game_id)
...
@external
func reveal{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(game_id: felt, move: felt, salt: felt):
    alloc_locals
...
func hash_move{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*,
range_check_ptr}(move: felt, salt: felt, player: felt) -> (hash: felt):
    alloc_locals
...
@view
func compute_winner{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*,
range_check_ptr}(move1: felt, move2: felt) -> (winner: felt):
